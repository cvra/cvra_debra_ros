...
sudo aptitude install -y ros-indigo-desktop-full
...
sudo aptitude install -y ros-indigo-ros-control ros-indigo-ros-controllers ros-indigo-joystick-drivers ros-indigo-robot-state-publisher
...
sudo aptitude update
sudo aptitude install -y ros-indigo-gazebo-ros-pkgs ros-indigo-gazebo-ros-control gazebo2 libsdformat1 ros-indigo-gazebo-plugins ros-indigo-gazebo-ros
